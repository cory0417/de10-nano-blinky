...
add_instance button_pio altera_avalon_pio 24.1
...
add_instance dipsw_pio altera_avalon_pio 24.1
...
set_instance_parameter_value dipsw_pio {generateIRQ} {0}
...
add_instance led_pio altera_avalon_pio 24.1
...
set_instance_parameter_value led_pio {width} {6}

add_instance mm_bridge_0 altera_avalon_mm_bridge 24.1
...
set_instance_parameter_value pll_0 {gui_output_clock_frequency0} {100.0}
...
add_instance pulse_cfg_0 pulse_cfg 1.0
set_instance_parameter_value pulse_cfg_0 {AW} {2}
set_instance_parameter_value pulse_cfg_0 {DW} {32}
set_instance_parameter_value pulse_cfg_0 {N} {2}

add_instance pulse_delay_pio altera_avalon_pio 24.1
set_instance_parameter_value pulse_delay_pio {bitClearingEdgeCapReg} {0}
set_instance_parameter_value pulse_delay_pio {bitModifyingOutReg} {0}
set_instance_parameter_value pulse_delay_pio {captureEdge} {0}
set_instance_parameter_value pulse_delay_pio {direction} {Output}
set_instance_parameter_value pulse_delay_pio {edgeType} {RISING}
set_instance_parameter_value pulse_delay_pio {generateIRQ} {0}
set_instance_parameter_value pulse_delay_pio {irqType} {LEVEL}
set_instance_parameter_value pulse_delay_pio {resetValue} {0.0}
set_instance_parameter_value pulse_delay_pio {simDoTestBenchWiring} {0}
set_instance_parameter_value pulse_delay_pio {simDrivenValue} {0.0}
set_instance_parameter_value pulse_delay_pio {width} {32}

add_instance pulse_start_pio altera_avalon_pio 24.1
set_instance_parameter_value pulse_start_pio {bitClearingEdgeCapReg} {0}
set_instance_parameter_value pulse_start_pio {bitModifyingOutReg} {0}
set_instance_parameter_value pulse_start_pio {captureEdge} {0}
set_instance_parameter_value pulse_start_pio {direction} {Output}
set_instance_parameter_value pulse_start_pio {edgeType} {RISING}
set_instance_parameter_value pulse_start_pio {generateIRQ} {0}
set_instance_parameter_value pulse_start_pio {irqType} {LEVEL}
set_instance_parameter_value pulse_start_pio {resetValue} {0.0}
set_instance_parameter_value pulse_start_pio {simDoTestBenchWiring} {0}
set_instance_parameter_value pulse_start_pio {simDrivenValue} {0.0}
set_instance_parameter_value pulse_start_pio {width} {1}

add_instance pulse_width_pio altera_avalon_pio 24.1
set_instance_parameter_value pulse_width_pio {bitClearingEdgeCapReg} {0}
set_instance_parameter_value pulse_width_pio {bitModifyingOutReg} {0}
set_instance_parameter_value pulse_width_pio {captureEdge} {0}
set_instance_parameter_value pulse_width_pio {direction} {Output}
set_instance_parameter_value pulse_width_pio {edgeType} {RISING}
set_instance_parameter_value pulse_width_pio {generateIRQ} {0}
set_instance_parameter_value pulse_width_pio {irqType} {LEVEL}
set_instance_parameter_value pulse_width_pio {resetValue} {0.0}
set_instance_parameter_value pulse_width_pio {simDoTestBenchWiring} {0}
set_instance_parameter_value pulse_width_pio {simDrivenValue} {0.0}
set_instance_parameter_value pulse_width_pio {width} {32}
...
add_interface pll_0_refclk clock sink
set_interface_property pll_0_refclk EXPORT_OF pll_0.refclk
add_interface pulse_cfg_0_delay_bus conduit end
set_interface_property pulse_cfg_0_delay_bus EXPORT_OF pulse_cfg_0.delay_bus
add_interface pulse_cfg_0_width_bus conduit end
set_interface_property pulse_cfg_0_width_bus EXPORT_OF pulse_cfg_0.width_bus
add_interface pulse_delay_pio conduit end
set_interface_property pulse_delay_pio EXPORT_OF pulse_delay_pio.external_connection
add_interface pulse_start_pio conduit end
set_interface_property pulse_start_pio EXPORT_OF pulse_start_pio.external_connection
add_interface pulse_width_pio conduit end
set_interface_property pulse_width_pio EXPORT_OF pulse_width_pio.external_connection
...
add_connection clk_0.clk pulse_cfg_0.clock

add_connection clk_0.clk pulse_delay_pio.clk

add_connection clk_0.clk pulse_start_pio.clk

add_connection clk_0.clk pulse_width_pio.clk
...
add_connection clk_0.clk_reset pulse_cfg_0.reset

add_connection clk_0.clk_reset pulse_delay_pio.reset

add_connection clk_0.clk_reset pulse_start_pio.reset

add_connection clk_0.clk_reset pulse_width_pio.reset

add_connection hps_0.h2f_axi_master pulse_cfg_0.avalon_slave_0
set_connection_parameter_value hps_0.h2f_axi_master/pulse_cfg_0.avalon_slave_0 arbitrationPriority {1}
set_connection_parameter_value hps_0.h2f_axi_master/pulse_cfg_0.avalon_slave_0 baseAddress {0x0000}
set_connection_parameter_value hps_0.h2f_axi_master/pulse_cfg_0.avalon_slave_0 defaultConnection {0}
...
add_connection mm_bridge_0.m0 pulse_delay_pio.s1
set_connection_parameter_value mm_bridge_0.m0/pulse_delay_pio.s1 arbitrationPriority {1}
set_connection_parameter_value mm_bridge_0.m0/pulse_delay_pio.s1 baseAddress {0x1000}
set_connection_parameter_value mm_bridge_0.m0/pulse_delay_pio.s1 defaultConnection {0}

add_connection mm_bridge_0.m0 pulse_start_pio.s1
set_connection_parameter_value mm_bridge_0.m0/pulse_start_pio.s1 arbitrationPriority {1}
set_connection_parameter_value mm_bridge_0.m0/pulse_start_pio.s1 baseAddress {0x0000}
set_connection_parameter_value mm_bridge_0.m0/pulse_start_pio.s1 defaultConnection {0}

add_connection mm_bridge_0.m0 pulse_width_pio.s1
set_connection_parameter_value mm_bridge_0.m0/pulse_width_pio.s1 arbitrationPriority {1}
set_connection_parameter_value mm_bridge_0.m0/pulse_width_pio.s1 baseAddress {0x2000}
set_connection_parameter_value mm_bridge_0.m0/pulse_width_pio.s1 defaultConnection {0}

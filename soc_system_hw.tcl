...
proc compose { } {
    ...
    add_connection clk_0.clk pulse_delay_pio.clk clock

    add_connection clk_0.clk pulse_start_pio.clk clock

    add_connection clk_0.clk pulse_width_pio.clk clock

    add_connection clk_0.clk_reset mm_bridge_0.reset reset

    add_connection clk_0.clk_reset pulse_delay_pio.reset reset

    add_connection clk_0.clk_reset pulse_start_pio.reset reset

    add_connection clk_0.clk_reset pulse_width_pio.reset reset

    add_connection hps_0.h2f_axi_master mm_bridge_0.s0 avalon
